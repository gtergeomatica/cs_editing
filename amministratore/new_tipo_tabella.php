...
$query0= 'SELECT ST_Force2D(ST_Line_Interpolate_Point(geom, '.$_POST["prog_ini"].'/prog_fin)) as geom FROM geometrie.elementi_stradali WHERE cod_strada =\''.$_POST["cod_strada"].'\' and  prog_ini < '.$_POST["prog_ini"].' and prog_fin >'.$_POST["prog_ini"].';';
...
header("location: ../eventop.php?s=".$schema."&t=".$table."");
